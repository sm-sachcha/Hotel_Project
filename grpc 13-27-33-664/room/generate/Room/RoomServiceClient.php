...
class RoomServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Room\PBEmpty $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall<\Room\RoomListResponse>
     */
    public function ListRooms(\Room\PBEmpty $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/room.RoomService/ListRooms',
        $argument,
        ['\Room\RoomListResponse', 'decode'],
        $metadata, $options);
    }
